    ...
    public partial class MainPage : ContentPage
    {
        ...
        private async void BtnAdd_Clicked(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtNomeMercadoria.Text))
            {
                ...
                await DisplayAlert("Parabéns", "Mercadoria adicionada", "OK");
                //Get All Mercadoria
            ...
            {
                await DisplayAlert("Atenção", "Insira o nome da mercadoria", "OK");
            }
        }
        ...
        private async void BtnUpdate_Clicked(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtId.Text))
            {
                ...
                txtNomeProdutor.Text = string.Empty;
                txtProdutorEmail.Text = string.Empty;
                await DisplayAlert("Parabéns", "Mercadoria atualizada!", "OK");
                //Get All Mercadoria
                var ListProd = await App.SQLiteDb.GetItemsAsync();
                if (ListProd != null)
                {
